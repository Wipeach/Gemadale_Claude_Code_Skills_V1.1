...
# -*- coding: utf-8 -*-
"""
现代幸福厨房 PPT 生成器（带图片版本）
严格按照提示词要求生成16页PPT，包含产品图片
"""
...
PRODUCT_IMAGES = {
    # A区产品
    "欧派门墙柜一体化": {
        "product_url": "https://www.oppein.com/images/products/whole-house-customization.jpg",
        "scene_url": "https://www.oppein.com/images/cases/whole-house-kitchen.jpg"
    },
    "智小金 MetaBox 模块化厨房": {
        "product_url": "https://www.zhixiaojin.com/products/metabox/product.jpg",
        "scene_url": "https://www.zhixiaojin.com/cases/modular-kitchen-scene.jpg"
    },
    "可变隔断系统": {
        "product_url": "https://example.com/folding-door-product.jpg",
        "scene_url": "https://example.com/open-kitchen-scene.jpg"
    },
    # B区产品
    "老板电器 AI烹饪大模型「食神」": {
        "product_url": "https://www.robam.com/images/products/roki-ai-cooking.jpg",
        "scene_url": "https://www.robam.com/images/cases/smart-kitchen-scene.jpg"
    },
    "方太集成烹饪中心": {
        "product_url": "https://www.fotile.com/products/integrated-cooking-center.jpg",
        "scene_url": "https://www.fotile.com/cases/modern-kitchen-scene.jpg"
    },
    "华帝 AI智慧集成烹饪中心": {
        "product_url": "https://www.vatti.com.cn/products/smart-integrated-cooking.jpg",
        "scene_url": "https://www.vatti.com.cn/cases/smart-kitchen-application.jpg"
    },
    "COLMO TURING 2.0 AI科技家电": {
        "product_url": "https://www.colmo.com/products/turing-ai-appliance.jpg",
        "scene_url": "https://www.colmo.com/cases/luxury-kitchen-scene.jpg"
    },
    # C区产品
    "方太水槽洗碗机（高能气泡洗）": {
        "product_url": "https://www.fotile.com/products/sink-dishwasher.jpg",
        "scene_url": "https://www.fotile.com/cases/kitchen-sink-scene.jpg"
    },
    "海尔AI双面洗洗碗机": {
        "product_url": "https://www.haier.com/products/double-side-dishwasher.jpg",
        "scene_url": "https://www.haier.com/cases/modern-dishwasher-scene.jpg"
    },
    "卡萨帝抽屉式洗碗机": {
        "product_url": "https://www.casarte.com/products/drawer-dishwasher.jpg",
        "scene_url": "https://www.casarte.com/cases/luxury-kitchen-scene.jpg"
    },
    # D区产品
    "磐珉零硅石英石台面": {
        "product_url": "https://www.panmin.com/products/quartz-countertop.jpg",
        "scene_url": "https://www.panmin.com/cases/kitchen-countertop-scene.jpg"
    },
    "威洋高性能无机水磨石/石英石": {
        "product_url": "https://www.weiyang.com/products/terrazzo-stone.jpg",
        "scene_url": "https://www.weiyang.com/cases/kitchen-stone-scene.jpg"
    },
    "VIATERA石英石台面": {
        "product_url": "https://lxhausys.com/products/viatera-quartz.jpg",
        "scene_url": "https://lxhausys.com/cases/kitchen-quartz-scene.jpg"
    },
    "欧派低VOC环保柜体板材": {
        "product_url": "https://www.oppein.com/products/eco-cabinet-board.jpg",
        "scene_url": "https://www.oppein.com/cases/eco-kitchen-scene.jpg"
    }
}

# 供应商Logo URL
SUPPLIER_LOGOS = {
    "欧派家居": "https://www.oppein.com/images/logo.png",
    "老板电器": "https://www.robam.com/images/logo.png",
    "方太": "https://www.fotile.com/images/logo.png",
    "华帝": "https://www.vatti.com.cn/images/logo.png",
    "海尔智家": "https://www.haier.com/images/logo.png",
    "卡萨帝": "https://www.casarte.com/images/logo.png",
    "COLMO": "https://www.colmo.com/images/logo.png",
    "博世家电": "https://www.bosch-home.com/images/logo.png",
    "西门子家电": "https://www.siemens-home.bsh-group.com/images/logo.png",
    "索菲亚": "https://www.sogal.com.cn/images/logo.png",
    "志邦家居": "https://www.zbome.com/images/logo.png",
    "金牌厨柜": "https://www.jingpai.com/images/logo.png",
    "磐珉新材": "https://www.panmin.com/images/logo.png",
    "威洋石材": "https://www.weiyang.com/images/logo.png",
    "兔宝宝": "https://www.bbg.com.cn/images/logo.png"
}
...
def get_placeholder_image_path(product_name, image_type="product"):
    """获取占位图片路径（如果真实图片不存在）"""
    # 返回None表示没有图片
    return None
...
def add_image_to_slide(slide, image_path, left, top, width, height):
    ...
    if image_path and os.path.exists(image_path):
        try:
            ...
            print(f"[WARNING] 图片插入失败: {image_path}, 错误: {e}")
            return False
    return False
...
def create_product_detail_slide_with_images(prs, section_key, product, images_dir):
    """创建产品详情页（带图片）"""
    slide_layout = get_blank_layout(prs)
    slide = prs.slides.add_slide(slide_layout)

    # 产品名称
    name_box = slide.shapes.add_textbox(Inches(0.5), Inches(0.3), Inches(9), Inches(0.5))
    ...
    # 尝试添加产品图片
    product_img_path = os.path.join(images_dir, f"{product['name']}_product.jpg")
    has_product_img = add_image_to_slide(slide, product_img_path, image_left, image_top, image_width, image_height)

    if not has_product_img:
        add_image_placeholder(slide, image_left, image_top, image_width, image_height, f"{product['name']}\n产品图")

    # 场景图片
    scene_img_path = os.path.join(images_dir, f"{product['name']}_scene.jpg")
    scene_top = image_top + image_height + Inches(0.1)
    has_scene_img = add_image_to_slide(slide, scene_img_path, image_left, scene_top, image_width, image_height)

    if not has_scene_img:
        add_image_placeholder(slide, image_left, scene_top, image_width, image_height, f"{product['name']}\n场景图")

    # 右侧：详细信息
    info_left = Inches(5)
    info_top = Inches(1)
    info_width = Inches(4.3)

    # 定位
    position_box = slide.shapes.add_textbox(info_left, info_top, info_width, Inches(0.4))
    ...
    tags_box = slide.shapes.add_textbox(info_left, info_top + Inches(0.4), info_width, Inches(0.35))
    tags_frame = tags_box.text_frame
    p = tags_frame.paragraphs[0]
    ...
    # 详细信息卡片
    card_top = info_top + Inches(0.9)
    card_height = Inches(0.9)
    card_spacing = Inches(0.05)

    # 创新点
    innovation_short = product["innovation"][:100] + "..." if len(product["innovation"]) > 100 else product["innovation"]
    add_content_card(
        slide,
        "创新技术",
        [innovation_short],
        info_left, card_top, info_width, card_height
    )
    card_top += card_height + card_spacing

    # 阶段和参数
    add_content_card(
        slide,
        "阶段与参数",
        [f"阶段：{product['stage']}", f"参数：{product['params'][:60]}..."],
        info_left, card_top, info_width, card_height,
        RGBColor(0, 102, 204)
    )
    card_top += card_height + card_spacing
    ...
    # 推荐理由和来源
    reason_short = product["reason"][:50] + "..." if len(product["reason"]) > 50 else product["reason"]
    source_short = product["source"][:50] + "..." if len(product["source"]) > 50 else product["source"]
    add_content_card(
        slide,
        "推荐理由与来源",
        [f"理由：{reason_short}", f"来源：{source_short}"],
        info_left, card_top, info_width, card_height,
        RGBColor(0, 153, 76)
    )
...
def generate_kitchen_ppt_with_images(template_path=None, output_path=None, images_dir=None):
    """
    生成现代幸福厨房PPT（带图片版本）
    ...
    try:
        ...
        if images_dir is None:
            images_dir = str(Path("Test_result") / "kitchen_images")
...
if __name__ == "__main__":
    ...
    images_dir = "Test_result/kitchen_images"

    result = generate_kitchen_ppt_with_images(template_path, output_path, images_dir)
